...
char first_line[30]  = {"          "};//是否可以射击,最多放30个字符串，bool
...
static void Draw_char()
{
	...
	{
		Char_Graphic(&tx_client_char.clientData,"CL6",ADD,0,RED_BLUE,10,strlen(sixth_line),2,(1920-200),(1080*8/12),sixth_line);
...
void Client_graphic_delete_update(uint8_t delete_layer)//删除图层信息
{
		...
		HAL_UART_Transmit(&huart1,CliendTxBuffer,sizeof(tx_client_delete),200);
}
...
//	Figure_Graphic(&high_aim_figure.clientData[0],"AH1",ADD,LINE,3,YELLOW,0,0,1,  960-line_length,540+30                 ,0,  960+line_length,540+30);//graphic_Remove
//	Figure_Graphic(&high_aim_figure.clientData[1],"AH2",ADD,LINE,3,YELLOW,0,0,1,  960-line_length,540+30+division_value  ,0,  960+line_length,540+30+division_value  );
//	Figure_Graphic(&high_aim_figure.clientData[2],"AH3",ADD,CIRCLE,3,WHITE,0,0,1,  960-line_length,540+30+division_value*2,0,  960+line_length,540+30+division_value*2);
	Figure_Graphic(&high_aim_figure.clientData[0],"AH1",ADD,CIRCLE,1,WHITE,0,0,1,  940,540-division_value*4, 1,0,0);
	
	Figure_Graphic(&high_aim_figure.clientData[1],"AH2",ADD,LINE,1,GREEN,0,0,1,  859,450, 0,795,318);
	Figure_Graphic(&high_aim_figure.clientData[2],"AH3",ADD,LINE,1,YELLOW,0,0,1,  795,318, 0,731,186);
	Figure_Graphic(&high_aim_figure.clientData[3],"AH4",ADD,LINE,1,FUCHSIA,0,0,1,  731,186,0,666,53);
	
	Figure_Graphic(&high_aim_figure.clientData[4],"AH5",ADD,LINE,1,GREEN,0,0,1,  1071,450,0,  1134,318);
	Figure_Graphic(&high_aim_figure.clientData[5],"AH6",ADD,LINE,1,YELLOW,0,0,1,  1134,318,0,  1197,186);
	Figure_Graphic(&high_aim_figure.clientData[6],"AH7",ADD,LINE,1,FUCHSIA,0,0,1,  1197,186,0,  1260,53);
	
	
//		Figure_Graphic(&high_aim_figure.clientData[2],"AH3",ADD,LINE,1,CYAN_BLUE,0,0,1,  1071,450, 0,1260,53);
...
{ 
	...
	Figure_Graphic(&low_aim_shortfigure_3.clientData[5],"AS1",ADD,LINE,3,YELLOW,0,0,1,   960,            540+30+division_value*0 ,0,   960,            540+30);
