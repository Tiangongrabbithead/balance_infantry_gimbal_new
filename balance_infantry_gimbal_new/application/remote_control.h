...
typedef __packed struct
{
	uint16_t rc_keyW_time; 
	uint16_t rc_keyS_time;  
	uint16_t rc_keyA_time;  
	uint16_t rc_keyD_time; 
	uint16_t rc_keyShift_time; 
	uint16_t rc_keyCtrl_time;  
	uint16_t rc_keyQ_time;  
	uint16_t rc_keyE_time;  
	uint16_t rc_keyR_time; 
	uint16_t rc_keyF_time;  
	uint16_t rc_keyG_time; 
	uint16_t rc_keyZ_time;  
	uint16_t rc_keyX_time; 
	uint16_t rc_keyC_time;  
	uint16_t rc_keyV_time; 
	uint16_t rc_keyB_time;  
